...
local smallfont = love.graphics.newFont("lcd.ttf", 20)
local imagebuttonfont = love.graphics.newFont("lcd.ttf", 40)
local bordercolor = {0, 255, 0, 255}
local bodycolor={0,0,0,255}
...
-- frame
skin.controls.frame_body_color                      = {232, 232, 232, 0}
skin.controls.frame_name_color                      = {0, 255, 0, 255}
skin.controls.frame_name_font                       = smallfont

-- button
skin.controls.button_text_down_color                = {0, 0, 255, 255}
skin.controls.button_text_nohover_color             = {0, 255, 0, 200}
skin.controls.button_text_hover_color               = {100, 255, 100, 255}
skin.controls.button_text_nonclickable_color        = {255, 0, 0, 100}
...
-- panel
skin.controls.panel_body_color                      = {0, 0, 0, 255}
...
skin.controls.textinput_indicator_color             = {0, 255, 0, 255}
skin.controls.textinput_text_normal_color           = {0, 255, 0, 255}
...
-- slider
skin.controls.slider_bar_outline_color              = {50, 50, 50, 255}
...
function skin.DrawTextInput(object)
	...
	love.graphics.setColor(230, 230, 230, 0)
	skin.OutlinedRectangle(x + 1, y + 1, width - 2, height - 2)
